...
// egressCtMap is the internal representation of an egress policy map.
type egressPolicyMap struct {
	*ebpf.Map
}

// initEgressCtMap initializes the egress policy map.
func initEgressPolicyMap(policyMapName string) error {
